...
export interface Safe_l2Interface extends Interface {
  ...
  encodeFunctionData(functionFragment: 'setModuleGuard', values: [AddressLike]): string
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'checkNSignatures(bytes32,bytes,bytes,uint256)', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'checkNSignatures(address,bytes32,bytes,uint256)', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'checkSignatures(bytes32,bytes,bytes)', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'checkSignatures(address,bytes32,bytes)', data: BytesLike): Result
...
export namespace SafeModuleTransactionEvent {
  ...
  export type OutputTuple = [module: string, to: string, value: bigint, data: string, operation: bigint]
  export interface OutputObject {
    module: string
    to: string
    value: bigint
...
export interface Safe_l2 extends BaseContract {
  ...
  'checkNSignatures(address,bytes32,bytes,uint256)': TypedContractMethod<
    [executor: AddressLike, dataHash: BytesLike, signatures: BytesLike, requiredSignatures: BigNumberish],
    [void],
    'view'
  >
  ...
  setModuleGuard: TypedContractMethod<[moduleGuard: AddressLike], [void], 'nonpayable'>
  ...
  ): TypedContractMethod<[dataHash: BytesLike, data: BytesLike, signatures: BytesLike], [void], 'view'>
  getFunction(
    nameOrSignature: 'checkSignatures(address,bytes32,bytes)',
  ): TypedContractMethod<[executor: AddressLike, dataHash: BytesLike, signatures: BytesLike], [void], 'view'>
  getFunction(
  ...
  getFunction(nameOrSignature: 'setModuleGuard'): TypedContractMethod<[moduleGuard: AddressLike], [void], 'nonpayable'>
  getFunction(
  ...
  ): TypedContractMethod<[targetContract: AddressLike, calldataPayload: BytesLike], [void], 'nonpayable'>
  getFunction(
  ...
  getEvent(
    key: 'AddedOwner',
  ): TypedContractEvent<AddedOwnerEvent.InputTuple, AddedOwnerEvent.OutputTuple, AddedOwnerEvent.OutputObject>
  getEvent(
    key: 'ApproveHash',
  ): TypedContractEvent<ApproveHashEvent.InputTuple, ApproveHashEvent.OutputTuple, ApproveHashEvent.OutputObject>
  getEvent(
  ...
  getEvent(
    key: 'ChangedGuard',
  ): TypedContractEvent<ChangedGuardEvent.InputTuple, ChangedGuardEvent.OutputTuple, ChangedGuardEvent.OutputObject>
  getEvent(
  ...
  getEvent(
    key: 'EnabledModule',
  ): TypedContractEvent<EnabledModuleEvent.InputTuple, EnabledModuleEvent.OutputTuple, EnabledModuleEvent.OutputObject>
  getEvent(
  ...
  getEvent(
    key: 'RemovedOwner',
  ): TypedContractEvent<RemovedOwnerEvent.InputTuple, RemovedOwnerEvent.OutputTuple, RemovedOwnerEvent.OutputObject>
  getEvent(
  ...
  getEvent(
    key: 'SafeReceived',
  ): TypedContractEvent<SafeReceivedEvent.InputTuple, SafeReceivedEvent.OutputTuple, SafeReceivedEvent.OutputObject>
  getEvent(
    key: 'SafeSetup',
  ): TypedContractEvent<SafeSetupEvent.InputTuple, SafeSetupEvent.OutputTuple, SafeSetupEvent.OutputObject>
  getEvent(
    key: 'SignMsg',
  ): TypedContractEvent<SignMsgEvent.InputTuple, SignMsgEvent.OutputTuple, SignMsgEvent.OutputObject>
