...
export interface Compatibility_fallback_handler extends BaseContract {
  ...
  encodeMessageDataForSafe: TypedContractMethod<[safe: AddressLike, message: BytesLike], [string], 'view'>
  ...
  getMessageHashForSafe: TypedContractMethod<[safe: AddressLike, message: BytesLike], [string], 'view'>

  getModules: TypedContractMethod<[], [string[]], 'view'>

  isValidSignature: TypedContractMethod<[_dataHash: BytesLike, _signature: BytesLike], [string], 'view'>
  ...
  simulate: TypedContractMethod<[targetContract: AddressLike, calldataPayload: BytesLike], [string], 'nonpayable'>
